<?php /*a:3:{s:42:"F:\web\yiyanyun\app\admin\view\online.html";i:1651023685;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1651734461;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1649898267;}*/ ?>
<!--
 * @Author: Lucifer
 * @Date: 2022-04-17 21:18:05
 * @LastEditTime: 2022-04-27 09:40:42
 * @FilePath: \yiyanyun\app\admin\view\online.html
-->
<!--
 *                                                     __----~~~~~~~~~~~------___
 *                                    .  .   ~~//====......          __--~ ~~
    ...
    <div class="lyear-layout-container">
      ...
      <aside class="lyear-layout-sidebar">
        ...
        <div id="logo" class="sidebar-header">
          <a href="/admin/index.html"><img src="/static/images/logo-sidebar.png" title="LightYear"
              alt="LightYear" /></a>
        </div>
        <div class="lyear-layout-sidebar-info lyear-scroll">
          <nav class="sidebar-main">
            <ul class="nav-drawer">
              ...
              <li class="nav-item nav-item-has-subnav">
                <a href="javascript:void(0)"><i class="mdi mdi-devices"></i> <span>设备管理</span></a>
                <ul class="nav nav-subnav">
                  <li> <a href="/admin/mac">用户设备</a> </li>
                  <li> <a href="/admin/online">在线用户</a> </li>
                </ul>
              </li>
            </ul>
          </nav>
          ...
          <div class="sidebar-footer">
            <p class="copyright">Copyright &copy; <?php echo config('web.copyright'); ?>. <a target="_blank"
                href="http://lyear.itshubao.com"><?php echo config('web.copyright'); ?></a> All
              rights reserved.</p>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <div class="lyear-notifications">
                  ...
                  <div class="lyear-notifications-title clearfix" data-stopPropagation="true"><a href="#!"
                      class="float-right">查看全部</a>你有 10 条未读消息</div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <header class="card-header">
                        <div class="card-title">在线用户统计与列表</div>
                    </header>
                    <div class="card-body">

                        <ul class="nav nav-pills nav-fill mb-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#cloud" aria-selected="true">统计图</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#pro" aria-selected="false">在线列表</a>
                            </li>
                        </ul>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input ids"
                                                            name="ids[]" value="<?php echo htmlentities($code['id']); ?>" id="ids-<?php echo htmlentities($code['id']); ?>">
                                                        <label class="custom-control-label"
                                                            for="ids-<?php echo htmlentities($code['id']); ?>"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo htmlentities($code['id']); ?></td>
                                                <td><?php echo htmlentities($code['pid']); ?></td>
                                                <td><?php echo htmlentities($code['user']); ?></td>
                                                <td><?php echo htmlentities($code['nick']); ?></td>
                                                <td><?php echo htmlentities($code['ip']); ?></td>
                                                <td><?php echo htmlentities($code['time']); ?></td>
                                                <td><?php echo htmlentities($code['VIP']); ?></td>
                                                <td><?php if($code['status'] == 'y'): ?>正常<?php else: ?>禁用<?php endif; ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                            href="/admin/user/editview?id=<?php echo htmlentities($code['id']); ?>" title=""
...
<script>
    new Chart($("#chart-doughnut"), {
        ...
        data: {
            labels: ["用户总量", "在线用户"],
            datasets: [{
                data: [1, '<?php echo htmlentities($user_total); ?>'],
