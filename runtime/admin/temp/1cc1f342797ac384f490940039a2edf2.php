<?php /*a:3:{s:41:"F:\web\yiyanyun\app\admin\view\scode.html";i:1652099957;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1654067260;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1654067740;}*/ ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-purple"><?php echo htmlentities($code['pid']); ?></span>
                                            </td>
                                            <td><?php if($code['end_time'] == ''): ?><span class="badge badge-yellow">未使用卡</span><?php else: ?><span class="badge badge-danger"><?php echo htmlentities(date('Y-m-d H:s:i',!is_numeric($code['use_time'])? strtotime($code['use_time']) : $code['use_time'])); ?>:<?php echo htmlentities(date('Y-m-d H:s:i',!is_numeric($code['end_time'])? strtotime($code['end_time']) : $code['end_time'])); ?><?php endif; ?></span></td>
                                            <td><?php echo htmlentities($code['time']); ?></td>
                                            <td><?php echo htmlentities($code['value']); ?></td>
                                            <td>
                                                <span class="badge badge-pink"><?php echo htmlentities($code['operator']); ?></span>
                                            </td>
                                            <td><?php if($code['status'] == 'y'): ?>
                                                <span class="badge badge-success">正常</span><?php else: ?>
                                                <span class="badge badge-dark">禁用</span><?php endif; ?>
                                            </td>
                                        </tr>
