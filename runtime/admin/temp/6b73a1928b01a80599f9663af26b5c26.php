<?php /*a:3:{s:43:"F:\web\yiyanyun\app\admin\view\project.html";i:1647768273;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1654067260;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1654067740;}*/ ?>
<!--
 * @Author       : Lucifer
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($code['name']); ?></td>
                                            <td><?php echo htmlentities($code['time']); ?></td>
                                            <td><?php if($code['status'] == 'y'): ?>正常<?php else: ?>禁用<?php endif; ?></td>
                                            <td>
                                                <div class="btn-group">
                                                  <a class="btn btn-xs btn-default" href="/admin/project/proedit?id=<?php echo htmlentities($code['id']); ?>" title="" data-toggle="tooltip" data-original-title="编辑"><i class="mdi mdi-pencil"></i></a>
                                                </div>
                                              </td>
                                        </tr>
