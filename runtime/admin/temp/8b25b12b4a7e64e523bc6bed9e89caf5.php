<?php /*a:3:{s:42:"F:\web\yiyanyun\app\admin\view\update.html";i:1654066969;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1654067260;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1654067740;}*/ ?>
<!--
 * @Author       : Lucifer
 * @Date         : 2022-05-29 15:00:33
 * @LastEditTime : 2022-06-01 15:02:38
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <h4>最新版本</h4>
                            <h6><?php echo htmlentities($info['version']); ?></h6>

                            <div>
                                <p><?php echo htmlentities($info['content']); ?></p>
                                <p>本次更新包大小为：<?php echo htmlentities($size); ?></p>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#!" class="guide-box" data-navigateable="true">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button class="btn btn-secondary <?php echo htmlentities($disabled); ?>" data-wizard="next"
