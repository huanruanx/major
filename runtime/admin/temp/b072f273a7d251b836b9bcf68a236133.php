<?php /*a:3:{s:45:"F:\web\yiyanyun\app\admin\view\agentedit.html";i:1649747102;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1652011513;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1649898267;}*/ ?>
<!--
 * @Author: Lucifer
 * @Date: 2022-04-12 15:04:55
 * @LastEditTime: 2022-04-12 15:04:55
 * @FilePath: \yiyanyun\app\admin\view\agentedit.html
-->
<!--
 * @Author       : Lucifer
...
<main class="lyear-layout-content">
    ...
    <div class="container-fluid p-t-15">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">代理管理</a></li>
                <li class="breadcrumb-item"><a href="/admin/user">代理列表</a></li>
                <li class="breadcrumb-item active" aria-current="page">代理编辑</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <p class="mt-1 mb-0">代理ID：<?php echo htmlentities($id); ?></p>
                                <p class="mt-1 mb-0">余额：<?php echo htmlentities($balance); ?></p>
                            </div>
                        </div>
                        <hr>
                        <form method="" action="#!" class="site-form">
                            <div class="form-group">
                                <label for="nickname">余额</label>
                                <input type="text" class="form-control" name="nickname" id="balance"
                                    placeholder="" value="<?php echo htmlentities($balance); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nickname">天卡</label>
                                <input type="text" class="form-control" name="nickname" id="day"
                                    placeholder="" value="<?php echo htmlentities($day); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nickname">周卡</label>
                                <input type="text" class="form-control" name="nickname" id="zhou"
                                    placeholder="" value="<?php echo htmlentities($zhou); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nickname">月卡</label>
                                <input type="text" class="form-control" name="nickname" id="month"
                                    placeholder="" value="<?php echo htmlentities($month); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nickname">年卡</label>
                                <input type="text" class="form-control" name="nickname" id="year"
                                    placeholder="" value="<?php echo htmlentities($year); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nickname">永久</label>
                                <input type="text" class="form-control" name="nickname" id="permanent"
                                    placeholder="未保存有昵称" value="<?php echo htmlentities($permanent); ?>">
                            </div>
                            <button type="button" onclick="agents()" class="btn btn-outline-yellow btn-block">保存</button>
                        </form>
...
<script>
    function agents() {
        ...
        $.post("<?php echo url('/admin/agent/edits'); ?>", { 
            balance: balance, 
            id: id, 
            day: day, 
            permanent:permanent,
