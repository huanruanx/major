<?php /*a:3:{s:40:"F:\web\yiyanyun\app\admin\view\shop.html";i:1651632663;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1651631066;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1649898267;}*/ ?>
<!--
 * @Author       : Lucifer
 * @Date         : 2022-05-04 10:48:40
 * @LastEditTime : 2022-05-04 10:50:58
 * @FilePath     : \yiyanyun\app\admin\view\shop.html
-->
        ...
        <div class="lyear-layout-sidebar-info lyear-scroll">
          <nav class="sidebar-main">
            <ul class="nav-drawer">
              ...
              <li class="nav-item nav-item-has-subnav">
                <a href="javascript:void(0)"><i class="mdi mdi-devices"></i> <span>商店管理</span></a>
                <ul class="nav nav-subnav">
                  <li> <a href="/admin/shop">商品列表</a> </li>
                </ul>
              </li>
              <li class="nav-item nav-item-has-subnav">
                <a href="javascript:void(0)"><i class="mdi mdi-menu"></i> <span>其他设置</span></a>
                <ul class="nav nav-subnav">
                  <li> <a href="#!">发卡配置(下个版本更新)</a> </li>
                  <li> <a href="/admin/update">系统更新</a> </li>
                  <li> <a href="/admin/paylist">支付通道</a> </li>
                </ul>
              </li>
            </ul>
          </nav>
