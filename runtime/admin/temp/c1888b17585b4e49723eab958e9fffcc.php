<?php /*a:3:{s:41:"F:\web\yiyanyun\app\admin\view\error.html";i:1654069788;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1654067260;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1654067740;}*/ ?>
<!--
 * @Author       : Lucifer
 * @Date         : 2022-05-06 10:58:56
 * @LastEditTime : 2022-06-01 15:49:46
 * @FilePath     : \yiyanyun\app\admin\view\error.html
-->
<!--
 * @Author       : Lucifer
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p>错误原因：<a href="" class="text-danger"><?php echo htmlentities($reason); ?></a></p>
                        </div>
                        <button type="button" class="btn btn-outline-info btn-block">返回页面</button>
                        <button type="button" onclick="yun_logout()"
                            class="btn btn-outline-purple btn-block">清理云端</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function yun_logout() {
        $.post("<?php echo url('/admin/yun/logout'); ?>", {}, function (res) {
            if (res.code == 200) {
