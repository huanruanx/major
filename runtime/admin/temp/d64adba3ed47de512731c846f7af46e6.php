<?php /*a:3:{s:40:"F:\web\yiyanyun\app\admin\view\user.html";i:1648034274;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1654067260;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1654067740;}*/ ?>
<!--
 * @Author       : Lucifer
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <select class="custom-select" name="pid" required>
                                            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$projectlist): $mod = ($i % 2 );++$i;?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                  <a class="btn btn-xs btn-default" href="/admin/user/editview?id=<?php echo htmlentities($code['id']); ?>" title="" data-toggle="tooltip" data-original-title="编辑"><i class="mdi mdi-pencil"></i></a>
                                                </div>
                                              </td>
                                        </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
