<?php /*a:3:{s:39:"F:\web\yiyanyun\app\admin\view\apl.html";i:1649754384;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1652056195;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1649898267;}*/ ?>
<!--
 * @Author: Lucifer
 * @Date: 2022-04-12 15:08:41
 * @LastEditTime: 2022-04-12 17:05:37
 * @FilePath: \yiyanyun\app\admin\view\apl.html
-->
<!--
 * @Author       : Lucifer
 * @Date         : 2022-05-06 19:46:46
 * @LastEditTime : 2022-05-09 08:29:55
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($code['day']); ?></td>
                                        <td><?php echo htmlentities($code['zhou']); ?></td>
                                        <td><?php echo htmlentities($code['month']); ?></td>
                                        <td><?php echo htmlentities($code['year']); ?></td>
                                        <td><?php echo htmlentities($code['permanent']); ?></td>
                                        <td><?php if($code['status'] == 'y'): ?>正常<?php else: ?>禁用<?php endif; ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default"
                                                    href="/admin/agent/editview?id=<?php echo htmlentities($code['aid']); ?>" title=""
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select class="custom-select" name="aid" required>
                        <?php if(is_array($alist) || $alist instanceof \think\Collection || $alist instanceof \think\Paginator): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alist): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities($alist['id']); ?>"><?php echo htmlentities($alist['user']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <select class="custom-select" name="pid" required>
                    <?php if(is_array($plist) || $plist instanceof \think\Collection || $plist instanceof \think\Paginator): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$projectlist): $mod = ($i % 2 );++$i;?>
