<?php /*a:3:{s:44:"F:\web\yiyanyun\app\admin\view\useredit.html";i:1652408152;s:49:"F:\web\yiyanyun\app\admin\view\public\header.html";i:1652400907;s:49:"F:\web\yiyanyun\app\admin\view\public\footer.html";i:1652233101;}*/ ?>
<!--
 * @Author       : Lucifer
 * @Date         : 2022-04-10 20:27:36
 * @LastEditTime : 2022-05-13 10:15:51
 * @FilePath     : \yiyanyun\app\admin\view\useredit.html
-->
<!--
 * @Author       : Lucifer
 * @Date         : 2022-05-06 19:46:46
 * @LastEditTime : 2022-05-13 08:15:06
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="/static/images/users/avatar.jpg" class="rounded" alt="...">
                            <div style="margin-top:20px;">
                                <p>用户名:<?php echo htmlentities($user); ?></p>
                                <p>用户ID:<?php echo htmlentities($id); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form method="" action="#!" class="site-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nickname" id="nickname"
                                    placeholder="未保存有昵称" value="<?php echo htmlentities($nick); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="remark" placeholder="暂无简介..." id="remark" rows="3"
                                    disabled></textarea>
                            </div>
...
<script type="text/javascript">
    ...
    function user() {
        ...
        $.post("<?php echo url('edits'); ?>", { email: email, nickname: nickname, id: id }, function (res) {
            if (res.code == 200) {
